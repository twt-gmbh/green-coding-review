...
# optimize solution based on memory
...
class Solution:
    def sortList(self, head: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while step < length:
            ...
            while current:
                ...
                merged_tail = self.merge(left, right, tail)
                tail = self.updateTail(merged_tail, step)
    ...
    def updateTail(self, tail, step):
        while step > 0 and tail.next:
            tail = tail.next
            step -= 1
        return tail
